...
PLOT_NAME = "relative_performance_category_v4.png"
PLOT_TITLE = ""
X_LABEL = ""
...
def calculate_relative_performance(df):
    ...
    # 1. Define which methods belong to which category
    category_mapping = {
        # Filters
        "ANOVA": "non-search",
        "CART": "non-search",
        "ElasticNet": "non-search",
        "GainRatio": "non-search",
        "LaplacianScore": "non-search",
        "Lasso": "non-search",
        "LOCO": "search",
        "MarkovBlanket": "non-search",
        "mRMR": "non-search",
        "MutualInformation": "non-search",
        "Random": "random",
        "ReliefF": "non-search",
        "RFImportance": "non-search",
        "RFE": "search",
        "SFS": "search",
    }
